...
variable "packages" {
  type        = map(string)
  description = "Version info for the installer scripts"
  default = {
...
variable "vbox_opts" {
  type        = map(string)
  description = "Default VirtualBox options <br><br> Full list of VM settings is available [here](https://www.virtualbox.org/manual/ch08.html#vboxmanage-modifyvm)"
  default = {
...
variable "http_proxy" {
  type        = string
  description = "HTTP proxy configuration (`<host>:<port>`)"
  default     = ""
}

variable "https_proxy" {
  type        = string
  description = "HTTPS proxy configuration (`<host>:<port>`)"
  default     = ""
}

variable "username" {
  type        = string
  description = "Default box username for authentication"
  default     = "vagrant"
}

variable "password" {
  type        = string
  description = "Default box password for authentication"
  sensitive   = true
  default     = "vagrant"
}
